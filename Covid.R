...
raw <- read.csv("/home/hammett/Downloads/Registre_de_casos_de_COVID-19_realitzats_a_Catalunya._Segregaci__per_sexe_i_municipi.csv", header = TRUE, sep=",")
...
ggplot(resum_ciutat, aes(TipusCasData, NumCasos)) +
   ...
   scale_color_manual(values = c("color.diari" = "grey80",
                      ...
                      labels = c("Casos diaris", "Mitjana casos diaris"),
                      name = "")
